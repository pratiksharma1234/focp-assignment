...
def generate_agent_name():
    ...
    return random.choice(["alish", "kapish", "ram", "shyam", "hari", "saurab", "sulav", "simon", "barun", "sujal"])
...
def start_chat():
    ...
    user_name = input("Welcome to the british college chatbot! Please enter your name: ").strip()
    print(f"{time_based_greeting()}, {user_name}! Welcome to the british college of nepal.")
